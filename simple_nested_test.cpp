 ...
 * Auto-generated from simple_nested_test.nym
 */
...
int main() {
    try {
        ...
        // crystal::manifest("Compiled from: simple_nested_test.nym");

        // Actual program execution
    crystal::manifest("Testing simple case");
    graphics::stl_basic::STLModel();
