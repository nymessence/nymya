 ...
 * Auto-generated from final_verification.nym
 */
...
int main() {
    try {
        ...
        // crystal::manifest("Compiled from: final_verification.nym");

        // Actual program execution
    crystal->manifest("Verification test after documentation updates");
    test_list.push_back(42);
    auto first_val = test_list[0];
