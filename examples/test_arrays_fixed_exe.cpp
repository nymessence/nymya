 ...
 * Auto-generated from test_arrays_fixed.nym
 */
...
int main() {
    try {
        ...
        // crystal::manifest("Compiled from: test_arrays_fixed.nym");

        // Actual program execution
    crystal::manifest("Testing array operations...");
    my_list.push_back(1);
    auto first = my_list[0];
    std::to_string(first);
    auto list_size = my_list::length();
