 ...
 * Auto-generated from tests/array_access_only.nym
 */
...
int main() {
    try {
        ...
        // crystal::manifest("Compiled from: tests/array_access_only.nym");

        // Actual program execution
    crystal::manifest("Testing NymyaLang compiler functionality...");
