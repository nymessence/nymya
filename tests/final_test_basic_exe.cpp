 ...
 * Auto-generated from final_test_basic.nym
 */
...
int main() {
    try {
        ...
        // crystal::manifest("Compiled from: final_test_basic.nym");
    ...
    auto element_0 = "";
    auto element_2 = "";
    crystal::manifest("Element values stored in variables");
    auto arr_length = "";
    crystal::manifest("All basic tests passed! Compiler is now functioning correctly.");
