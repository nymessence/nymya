 ...
 * Auto-generated from tests/rule110_basic_only.nym
 */
...
int main() {
    try {
        ...
        // crystal::manifest("Compiled from: tests/rule110_basic_only.nym");
    ...
    auto j = 0;
    auto new_element = new_row[j];
    std::to_string(j);
    std::to_string(new_element);
