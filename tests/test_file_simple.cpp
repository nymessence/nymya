 ...
 * Auto-generated from test_file_simple.nym
 */
...
int main() {
    try {
        ...
        // crystal::manifest("Compiled from: test_file_simple.nym");

        // Actual program execution
    crystal::manifest("Testing...");
    crystal::file::dalan_aya("test.txt");
    auto exists = crystal::file()->dalan_aya("test.txt");
