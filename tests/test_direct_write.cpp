 ...
 * Auto-generated from test_direct_write.nym
 */
...
int main() {
    try {
        ...
        // crystal::manifest("Compiled from: test_direct_write.nym");

        // Actual program execution
    crystal::manifest("Testing direct file write");
    auto content = "Hello, file writing test!\n";
    crystal::file::dalan_orin("direct_test.txt", content);
    crystal::manifest("Direct write succeeded");
    crystal::manifest("Direct write failed");
    auto exists = crystal::file()->dalan_aya("direct_test.txt");
    crystal::manifest("File exists after write");
    crystal::manifest("File does not exist after write");
