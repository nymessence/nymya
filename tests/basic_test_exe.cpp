 ...
 * Auto-generated from basic_test.nym
 */
...
int main() {
    try {
        ...
        // crystal::manifest("Compiled from: basic_test.nym");

        // Actual program execution
    test_list::append(1);
    test_list::append(0);
    test_list::append(1);
    crystal::manifest("List length: ", +, test_list, ., length, ., to_string, ();
    double i = 0;
    test_list::length();
    crystal::manifest("Element at ", +, i, ., to_string, ();
    ]::to_string();
    double test_string = "0123456789ABCDEF";
