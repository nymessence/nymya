 ...
 * Auto-generated from test_graphics_tags.nym
 */
...
int main() {
    try {
        ...
        // crystal::manifest("Compiled from: test_graphics_tags.nym");

        // Actual program execution
    crystal::manifest("Testing graphics library with @-tags...");
    auto model = graphics::ply_basic()->create_model();
    auto pos = graphics::ply_basic()->spherical_to_cartesian(45.0, 30.0, 100.0);
    crystal::manifest("Graphics library test completed");
