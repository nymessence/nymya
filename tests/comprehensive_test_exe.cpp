 ...
 * Auto-generated from tests/docker_test_comprehensive.nym
 */
...
int main() {
    try {
        ...
        // crystal::manifest("Compiled from: tests/docker_test_comprehensive.nym");

        // Actual program execution
    crystal::manifest("Docker test successful!");
    test_arr.push_back(42);
    test_arr.size();
    std::to_string(len);
