 ...
 * Auto-generated from test_submodule_direct.nym
 */
...
int main() {
    try {
        ...
        // crystal::manifest("Compiled from: test_submodule_direct.nym");

        // Actual program execution
    crystal::manifest("Testing direct submodule access...");
    auto model = stl_basic::STLModel();
