 ...
 * Auto-generated from tests/comprehensive_fix_test.nym
 */
...
int main() {
    try {
        ...
        // crystal::manifest("Compiled from: tests/comprehensive_fix_test.nym");

        // Actual program execution
    crystal::manifest("Basic functionality test...");
    std::vector<int> test_list;
    test_list.push_back(2);
    auto list_len = test_list::length();
    std::to_string(list_len);
    auto first_item = test_list[0];
    std::to_string(first_item);
