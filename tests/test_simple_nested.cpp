 ...
 * Auto-generated from test_simple_nested.nym
 */
...
int main() {
    try {
        ...
        // crystal::manifest("Compiled from: test_simple_nested.nym");

        // Actual program execution
    crystal::manifest("Testing basic nested namespace functionality");
