 ...
 * Auto-generated from test_ply_basic.nym
 */
...
int main() {
    try {
        ...
        // crystal::manifest("Compiled from: test_ply_basic.nym");

        // Actual program execution
    crystal::manifest("Testing PLY library...");
    auto model = graphics::ply_basic()->PlyModel();
    model->add_tetrahedron(0.0, 0.0, 0.0, 1.0, 255, 0, 0);
