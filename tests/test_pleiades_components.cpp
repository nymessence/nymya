 ...
 * Auto-generated from test_pleiades_components.nym
 */
...
int main() {
    try {
        ...
        // crystal::manifest("Compiled from: test_pleiades_components.nym");
    ...
    auto pos = graphics::ply_basic()->spherical_to_cartesian(45.0, 30.0, 100.0);
    auto ply_model = graphics::ply_basic()->PlyModel();
    auto stl_model = graphics::stl_basic()->STLModel();
    ply_model->add_tetrahedron(0.0, 0.0, 0.0, 1.0, 255, 255, 0);
    stl_model->add_bar(graphics, ., ply_basic, ., Point3D, (, 0.0, 0.0, 0.0);
